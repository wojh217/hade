...
import (
	...
	"github.com/wojh217/hade/framework/gin/binding"
	"github.com/golang/protobuf/proto"
	"github.com/stretchr/testify/assert"

	testdata "github.com/wojh217/hade/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/wojh217/hade/framework/gin.handlerNameTest$", c.HandlerName())
}
