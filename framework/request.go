...
type IRequest interface {
	...
	FormFile(key string) (*multipart.FileHeader, error) // 新增
	...
	// Header
	Headers() map[string][]string // 为什么value是个列表？
...
func (ctx *Context) BindJson(obj interface{}) error {
	if ctx.request != nil {
		...
		return errors.New("ctx.request emepty")
	}
	return nil
